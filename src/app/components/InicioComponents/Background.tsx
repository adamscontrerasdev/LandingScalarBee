...
const Scene = ({ scaleModel }: SceneProps) => {
  // Referencias para las luces direccionales
  ...
  return (
    <Canvas camera={{ position: [5, 0, 5] }}>
      ...
      <directionalLight
        ref={directionalLight1Ref} // Referencia para el helper
        position={[-5, -3, 5]} // Posición de la luz
        intensity={100} // Intensidad de la luz
        color={"#003566"} // Color de la luz (azul)
        castShadow // Habilita sombras
      />

      {/* Luz direccional desde la derecha */}
      <directionalLight
        ref={directionalLight2Ref} // Referencia para el helper
        position={[5, -5, 5]} // Posición de la luz
        intensity={20} // Intensidad de la luz
        color={"#F5CC00"} // Color de la luz (amarillo)
        castShadow // Habilita sombras
      />
