...
import StarBorder from "../Elements/ReusableElements/StartBorder";
...
export const BeneficiosContent: React.FC<BeneficiosContentProps> = ({
    ...
    return (
        <div className=" flex flex-col justify-center items-center gap-4 rounded-3xl w-full relative">
            <div
                className={`w-full  flex flex-col lg:flex-row justify-center items-center rounded-full px-5 gap-6 ${
                ...
                <div className="">
                    <span className="text-3xl text-[var(--primary-dark)]">Clientes</span>
                </div>
                <div>
                    <span className="text-3xl text-[var(--primary-dark)]">Ordenes de reparacion</span>
                </div>
                <div>
                    <span className="text-3xl text-[var(--primary-dark)]">Finanzas</span>
                </div>
            </div>
            ...
            <div
                ...
                <Title
                    value="Más control, menos esfuerzo"
                    redirect="#beneficios"
                />
            </div>
